    ...
    public int run(String... args) throws Exception {
        ...
        try {
            ...
            if (validator.isValidAmount(amountValue)) {
                System.out.println("The amount is valid: " + amountValue);
                return 0;
            }

            System.out.println("The amount is not valid: " + amountValue);

            return 1;
        }catch (NumberFormatException e){
            throw  new IllegalArgumentException("The command requires a number as argument");
        }
    }
}
